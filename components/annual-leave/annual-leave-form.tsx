...
interface AnnualLeaveFormProps {
  initialLeaves: LeaveRequestRecord[];
  initialUserInfo: UserBalance;
}
...
export function AnnualLeaveForm({
  ...
  const [leaves, setLeaves] = useState<LeaveRequestRecord[]>(initialLeaves);
  const [userInfo, setUserInfo] = useState<UserBalance>(initialUserInfo);
  ...
  const remainingLeaves = userInfo.totalLeaves - userInfo.usedLeaves;
